...
class HopperLongHeadEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    """
    ### Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        self,
        xml_file=os.getcwd() + "/adaptEnv/hopper_longhead.xml",
    ...
    def step(self, action):
        ...
        forward_reward = self._forward_reward_weight * np.minimum(x_velocity, 1)
